...
Public Class LectorTarjetaInteligenteShort
...
#Region "Metodos de Lector Tarjeta Inteligente"
    '  
    ...
    ' Set Pin Card
    '
    Public Sub PRESENTPINCard(ByVal CARDTYPE As String, ByVal PIN As String)
        Dim OKERR_OK As Object = Nothing
        Dim rc As IntPtr
    ...
    Private Sub PresentPinCard2W(ByVal PIN As String)
        Dim OKERR_OK As Object = Nothing
    ...
    ' Read SmartCard
    '
    Private Sub READCard(ByVal CARDTYPE As String, ByVal BYTESTOREAD As String)
        Dim OKERR_OK As Object = Nothing
        Dim rc As IntPtr
        Dim bData() As Byte
