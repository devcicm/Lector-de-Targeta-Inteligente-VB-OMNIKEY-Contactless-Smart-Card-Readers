...
Public Class LectorTarjetaInteligenteFull
    ...
    Dim var As String
    Dim ReaderList As New List(Of String)
    'BYTESTOREAD No. to Read (Hex)
    Dim BYTESTOREAD_Global As Integer = 100
...
#Region "Metodos de Datos"
    ...
    Private Function StrToArray(ByRef bArr() As Byte, ByVal str_Renamed As String) As IntPtr
        ...
        For i = 1 To iStrLen
            ...
            Else
                Dim mensaje = "Invalid Value ! Please enter hexadecimal values"
                Exit Function
            End If
...
#Region "Metodos de Lector Tarjeta"


    '
    ' Connect to Card
    '
    Public Sub CONNECT_LTI()
        ...
        If ReaderList IsNot Nothing AndAlso ReaderList.Count > 0 Then
            curReader = ReaderList(0)

        Else
            Console.WriteLine(("No Reader Selected"))
            Exit Sub
        End If
        ...
        If curReader IsNot Nothing AndAlso curReader IsNot "" Then
            ...
            If rc <> OKERR_OK Then
                Console.WriteLine(HandleError(rc))
                Exit Sub
            End If
            ...
            isCard = True
        Else
            Console.WriteLine("No se a podido conectar con el lector de tarjea")
        End If
    ...
    Public Sub DISCONNECT_LTI()
        ...
        Console.WriteLine("Disconnect successfull")
        isCard = False
    ...
    Public Sub ESTCONTEXT_LTI()
        ...
        If isContext = True Then RELCONTEXT_LTI()
        ...
        If rc = 0 Then
            ...
            While curReader(i) <> ""
                ReaderList.Add(curReader(i)) 'Add the readers name into the combobox
                Console.WriteLine(ReaderList(i).ToString())
        ...
        Console.WriteLine("Establish successfull, ListReaders successfull")
        isContext = True
    ...
    Private Sub INITI2CBUTTON_Click()
        ...
        If I2CTYPE = "ST14C02C" Then lType = SCardI2C.SCARD_I2C_TYPE.ST14C02C
        If I2CTYPE = "ST14C04C" Then lType = SCardI2C.SCARD_I2C_TYPE.ST14C04C
        If I2CTYPE = "ST14E32" Then lType = SCardI2C.SCARD_I2C_TYPE.ST14E32
        If I2CTYPE = "M14C04" Then lType = SCardI2C.SCARD_I2C_TYPE.M14C04
        If I2CTYPE = "M14C16" Then lType = SCardI2C.SCARD_I2C_TYPE.M14C16
        If I2CTYPE = "M14C32" Then lType = SCardI2C.SCARD_I2C_TYPE.M14C32
        If I2CTYPE = "M14C64" Then lType = SCardI2C.SCARD_I2C_TYPE.M14C64
        If I2CTYPE = "M14128" Then lType = SCardI2C.SCARD_I2C_TYPE.M14128
        If I2CTYPE = "M14256" Then lType = SCardI2C.SCARD_I2C_TYPE.M14256
        If I2CTYPE = "GFM2K" Then lType = SCardI2C.SCARD_I2C_TYPE.GFM2K
        If I2CTYPE = "GFM4K" Then lType = SCardI2C.SCARD_I2C_TYPE.GFM4K
        If I2CTYPE = "GFM32K" Then lType = SCardI2C.SCARD_I2C_TYPE.GFM32K
        If I2CTYPE = "AT24C01A" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C01A
        If I2CTYPE = "AT24C02" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C02
        If I2CTYPE = "AT24C04" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C04
        If I2CTYPE = "AT24C08" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C08
        If I2CTYPE = "AT24C16" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C16
        If I2CTYPE = "AT24C164" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C164
        If I2CTYPE = "AT24C32" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C32
        If I2CTYPE = "AT24C64" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C64
        If I2CTYPE = "AT24C128" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C128
        If I2CTYPE = "AT24C256" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C256
        If I2CTYPE = "AT24CS128" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24CS128
        If I2CTYPE = "AT24CS256" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24CS256
        If I2CTYPE = "AT24C512" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C512
        If I2CTYPE = "AT24C1024" Then lType = SCardI2C.SCARD_I2C_TYPE.AT24C1024
        ...
        If rc <> OKERR_OK Then
            ...
            Exit Sub
        End If
        Console.WriteLine("InitI2C successfull")
    End Sub

    Private Sub PRESENTPIN_Click(ByVal CARDTYPE As String, ByVal PIN As String)
        Dim OKERR_OK As Object = Nothing
        Dim rc As IntPtr
        ...
        Console.WriteLine("PresentPin successfull")

    End Sub

    Private Sub PresentPin2W_Click(ByVal PIN As String)
        Dim OKERR_OK As Object = Nothing
        ...
        If rc <> OKERR_OK Then
            ...
            Exit Sub
        End If
        Console.WriteLine("2W - PresentPin successfull")
    ...
    Private Sub PRESENTPIN3W_Click()
        ...
        Console.WriteLine("3W - PresentPin successfull")

    End Sub

    Private Sub READBUTTON_Click(ByVal CARDTYPE As String, ByVal BYTESTOREAD As String)
        Dim OKERR_OK As Object = Nothing
        Dim rc As IntPtr
        Dim bData() As Byte
        ...
        ulBytesToRead = HexStrToInt(BYTESTOREAD)
    ...
    '
    Public Sub READCard2W(ByVal BYTESTOREAD As String)
        Dim OKERR_OK As Object = Nothing
        ...
        Console.WriteLine("Read2W successfull")
        ' Show Data
    ...
    '
    Private Sub READCard3W(ByVal BYTESTOREAD As String, ByVal CARDTYPE As String)
    ...
    '
    Private Sub READCardI2C(ByVal BYTESTOREAD As String)
        Dim OKERR_OK As Object = Nothing
        ...
        ulBytesToRead = CInt(BYTESTOREAD)
        ...
        Console.WriteLine("ReadI2C successfull")
        ' Show data
        Console.WriteLine(OUT)
    ...
    ' Release context
    '
    Public Sub RELCONTEXT_LTI()
        Dim OKERR_OK As Object = Nothing
        Dim rc As IntPtr

        ' if a Card is connected, disconnect first
        If isCard = True Then DISCONNECT_LTI()

        ' check if a context is established
        If isContext = False Then

            Console.WriteLine("No context established")
        ...
        Console.WriteLine("Release successfull")
    ...
    Private Sub WRITECard(ByVal CARDTYPE As String, ByVal Adress As String, ByVal WRITEDATA As String)
        Dim OKERR_OK As Object = Nothing
        ...
        iAdress = HexStrToInt(Adress)
        bDataLen = StrToArray(bData, WRITEDATA)
        ...
        Console.WriteLine("WriteData successfull")

    End Sub

    Private Sub WRITECard2W(ByVal Adress As String, ByVal WRITEDATA As String)
        Dim OKERR_OK As Object = Nothing
        ...
        Console.WriteLine("2W WriteData successfull")

    End Sub

    Private Sub WRITECard3W(ByVal Adress As String, ByVal WRITEDATA As String)
        Dim OKERR_OK As Object = Nothing
        ...
        Console.WriteLine("3W WriteData successfull")

    End Sub

    Private Sub WRITECardI2C(ByVal WRITEDATA As String, ByVal Adress As String)
        Dim OKERR_OK As Object = Nothing
        ...
        ulBytesToWrite = StrToArray(bData, WRITEDATA)
        ...
        Else
            ...
            Call READCardI2C(BYTESTOREAD_Global)
        End If
